...
public:
    ...
    Magnet(MagnetKeySet key_set, sf::Vector2f position, int player, int strength, sf::Vector2f scale={0.1f, 0.1f});
    ~Magnet();
    ...
    void setForceSource(ForceSource* force_source_, RigidBody* body);
    void updateRotation();
